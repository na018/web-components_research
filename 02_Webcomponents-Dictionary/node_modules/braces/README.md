...
2. **sequences**: which are defined using a starting value and an ending value, separated by two slides: `a{1..3}b`. Optionally, a third argument may be passed to define a "step" or increment to use: `a{1..100..10}b`. These are also sometimes referred to as "ranges".
