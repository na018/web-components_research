...
export var VSlideXTransition = createSimpleTransition('_slide-x-transition');
export var VSlideXReverseTransition = createSimpleTransition('_slide-x-reverse-transition');
export var VSlideYTransition = createSimpleTransition('_slide-y-transition');
export var VSlideYReverseTransition = createSimpleTransition('_slide-y-reverse-transition');
